...
- After static asset deploys, probe every settings JS asset above. Do not treat the old single `settings.js` probe as full proof for the current UI.
...
`./scripts/verify-publish.sh` checks every mileage settings JS asset plus `scripts/test-mileage-date-helpers.mjs`. If a deploy follows, include hosted probes for `/assets/mileage/settings-date.js`, `/assets/mileage/settings-core.js`, `/assets/mileage/settings-ranges.js`, `/assets/mileage/settings-create.js`, `/assets/mileage/settings-admin.js`, `/assets/mileage/settings-tables.js`, and `/assets/mileage/settings.js`.
