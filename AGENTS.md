...
- Current hosted probes must include health, manifest, every settings asset, report assets, icon, unauthenticated iframe/report guards, prometheus metric families, scheduler liveness, and a no-PII metric tag audit.
